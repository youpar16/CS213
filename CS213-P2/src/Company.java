...
public class Company {
    ...
    /**
     * Helper method that prints the earning statements for all employees
     */
    public void print() { 
        if(numEmployee == 0){
    ...
    /**
     * Helper method that prints the earning statements for all employees categorized by department in the order: CS, ECE, then IT
    ...
    /**
     * Method that prints the list of employees by ascending date of employment. If two employees share the same date, they will be lexicographically sorted by name
     */
